...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        links.forEach((k,v) -> {
            Users u1 = users.get("user@gmail.com");
            Users u2 = users.get("super@gmail.com");
    ...
    private void addUsersAndRoles() {
        ...
        Users user = new Users("user@gmail.com",secret,true,"Joe","User","joedirt");
        user.addRole(userRole);
        user.setConfirmPassword(secret);
        userRepository.save(user);
        users.put("user@gmail.com",user);

        Users admin = new Users("admin@gmail.com",secret,true,"Joe","Admin","masteradmin");
        admin.addRole(adminRole);
        admin.setConfirmPassword(secret);
        userRepository.save(admin);
        users.put("admin@gmail.com",admin);

        Users master = new Users("super@gmail.com",secret,true,"Super","User","superduper");
